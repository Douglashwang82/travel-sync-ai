...
export default function TripBoardPage() {
  ...
  useEffect(() => {
    if (!isReady || !isLoggedIn || !tripId) return;
      ...
      <EmptyState
        ...
        description={
          <>
            ...
            <Link href="/liff/dashboard" className="underline">
              Back to your trips
            </Link>
            .
          </>
  ...
  const isOrganizer = board.currentUser.role === "organizer";
      ...
      <div className="sticky top-0 z-10 bg-[var(--background)]/95 backdrop-blur-sm border-b border-[var(--border)] px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="min-w-0">
            ...
            <h1 className="font-bold text-base truncate mt-0.5">
